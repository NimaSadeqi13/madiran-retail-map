...
const projectMedia: Record<string, Contract> = {
  ...
  "دزفول": { beforePhoto1: "/media/dezful/before-1.jpg", beforePhoto2: "/media/dezful/before-2.jpg", renderVideo: "/media/dezful/render.mp4" },
  ...
  "نور": { renderVideo: "/media/nur/render.mp4" },
};
...
const exhibitionProject: Project = { id: "retail-day-1404", city: "نمایشگاه ریتیل دی", brand: "xpoint", year: "۱۴۰۴", status: "completed", action: "نمایشگاه", lat: 0, lon: 0, pointNote: "", hideBefore: true, description: "برگزاری نمایشگاه ریتیل دی ۱۴۰۴", renderVideo: "/media/exhibition/retail-day-1404.mp4" };
...
const projectDescription = (project: Project) => project.description ?? (project.status === "completed" ? "\u0627\u062a\u0645\u0627\u0645 \u0627\u062c\u0631\u0627 \u0648 \u0634\u0631\u0648\u0639 \u0641\u0631\u0648\u0634" : activeProjectDescriptions[project.city] ?? "\u062f\u0631 \u062d\u0627\u0644 \u062a\u0648\u0633\u0639\u0647");
