...
export default function Home() {
  ...
  return <main>
    ...
    <section className="exhibition-reference" aria-labelledby="exhibition-title">
      <div className="exhibition-copy"><span className="eyebrow">رفرنس نمایشگاه</span><h2 id="exhibition-title">نمایشگاه ریتیل دی ۱۴۰۴</h2><p>ویدیوی رفرنس نمایشگاه ریتیل دی ۱۴۰۴.</p></div>
      <button className="exhibition-video" type="button" onClick={() => setMediaPreview({ src: "/media/exhibition/retail-day-1404.mp4", kind: "video", alt: "رفرنس نمایشگاه ریتیل دی ۱۴۰۴" })} aria-label="پخش ویدیوی رفرنس نمایشگاه ریتیل دی ۱۴۰۴">
        <video src="/media/exhibition/retail-day-1404.mp4" muted preload="metadata" />
        <span className="exhibition-video-shade" />
        <span className="play-icon">▶</span><b>پخش ویدیوی رفرنس</b>
      </button>
    </section>
