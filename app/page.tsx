...
type Contract = { leaseStart?: string; leaseEnd?: string; owner?: string; rent?: string; increase?: number; area?: string; deposit?: string; address?: string; phone?: string; facilityNote?: string; photo1?: string; photo2?: string; openingDate?: string; contractNote?: string };
...
const contracts: Record<string, Contract> = {
  ...
  "نکا": { leaseStart: "1404/06/05", leaseEnd: "1406/12/10", owner: "علی ازگلی", rent: "90/0000/000", increase: 0.20, contractNote: "قالب مبلغ اجاره در فایل منبع غیرمعمول است و بدون تغییر نمایش داده شده است." , area: "90", openingDate: "1404/07/20"},
  ...
  "ساوه": { leaseStart: "1404/07/20", leaseEnd: "1407/08/20", owner: "علیرضا رستگار", rent: "90/000/000", increase: 0.25 , area: "127", openingDate: "1404/08/30"},
  ...
  "نور": { leaseStart: "1405/04/13", leaseEnd: "1408/04/13", owner: "سید مسعود حسینی", rent: "122/000/000", increase: 0.25 , area: "150", openingDate: "شهریور 1405 (به‌زودی)", photo1: "/stores/nur-1.png", photo2: "/stores/nur-2.jpg"},
  ...
  "خرم‌آباد": { leaseStart: "1404/06/05", leaseEnd: "1407/06/05", owner: "بهمن راشدی", rent: "55/000/000", increase: 0.30 , area: "91", openingDate: "1404/07/10"},
  "نیشابور": { leaseStart: "1403/12/01", leaseEnd: "1406/12/01", owner: "تاجیک", rent: "80/000/000", increase: 0.30 , area: "170", openingDate: "1404/02/05"},
  "چالوس": { leaseStart: "1403/10/24", leaseEnd: "1406/10/24", owner: "علی حیدری - محسن کیاکجوری", rent: "66/000/000", increase: 0.25 , area: "75", openingDate: "1404/02/06"},
  "رفسنجان": { leaseStart: "1403/11/01", leaseEnd: "1406/11/01", owner: "امید افروزه", rent: "28/000/000", increase: 0.30 , area: "138", openingDate: "1404/04/15"},
  ...
  "تنکابن": { leaseStart: "1404/04/20", leaseEnd: "1407/04/20", owner: "ایران روشنی رودسری", rent: "80/000/000", increase: 0.25 , area: "100", openingDate: "1404/05/20"},
  "ورامین": { area: "140", openingDate: "1404/06/08" },
